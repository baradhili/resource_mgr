<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="start_year" class="form-control @error('year') is-invalid @enderror"
                value="{{ old('start_year', $allocation?->year) }}" id="year" placeholder="Year">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="start_month" class="form-control @error('month') is-invalid @enderror"
                value="{{ old('start_month', $allocation?->month) }}" id="month" placeholder="Month">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="end_year" class="form-control @error('year') is-invalid @enderror"
                value="{{ old('end_year', $allocation?->year) }}" id="year" placeholder="Year">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="end_month" class="form-control @error('month') is-invalid @enderror"
                value="{{ old('end_month', $allocation?->month) }}" id="month" placeholder="Month">
