<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <select name="roles" class="form-control @error('role') is-invalid @enderror" id="role">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <select name="current_team_id" class="form-control @error('current_team_id') is-invalid @enderror"
                id="current_team_id">
                <option value="">-- Select --</option>
            ...
            <select name="resource_id" class="form-control @error('resource_id') is-invalid @enderror" id="resource_id">
                ...
                @foreach ($resources as $resource)
                    <option value="{{ $resource->id }}"
                        {{ old('resource_id', $user?->resource_id) == $resource->id ? 'selected' : '' }}>
            ...
            <select name="reports" class="form-control @error('reports') is-invalid @enderror" id="reports">
                ...
                @foreach ($users as $key => $value)
                    <option value="{{ $value->id }}"
                        {{ old('reports', $user?->reports) == $value->id ? 'selected' : '' }}>{{ $value->name }}
                    </option>
                @endforeach
            </select>
