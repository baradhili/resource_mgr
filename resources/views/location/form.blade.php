<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="region_id" class="form-control @error('region_id') is-invalid @enderror" value="{{ old('region_id', $location?->region_id) }}" id="region_id" placeholder="Region Id">
