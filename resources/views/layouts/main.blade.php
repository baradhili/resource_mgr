                                ...
                                <div class="card-body py-3">
                                    <div class="chart chart-sm">
                                        ...
                                        <canvas id="chartjs-dashboard-line"
                                            style="display: block; height: 252px; width: 732px;" width="1464"
                                            height="504" class="chartjs-render-monitor"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="py-3">
                                            <div class="chart chart-xs">
                                                ...
                                                <canvas id="chartjs-dashboard-pie"
                                                    style="display: block; height: 200px; width: 277px;"
                        ...
                        <div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
                            <div class="card flex-fill w-100">
                                ...
                                <div class="card-body px-4">
                                    <div id="world_map" style="height: 350px; background-color: transparent;"
                                        class="jvm-container"><svg width="610" height="350">
                                            <defs></defs>
                                            <g id="jvm-regions-group"
                                                transform="scale(0.6777777777777778) translate(0, 37.84356593940892)">
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="GM" fill="#dee2e8" fill-opacity="1"
                                                ...
                                                <path
                                                    ...
                                                    data-code="GH" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="JO" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="HR" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="HT" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="HU" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="PT" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="PY" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="PA" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="PG" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="PE" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="PK" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="PH" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="PL" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="ZM" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="EH" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="EE" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="EG" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="ZA" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="EC" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AL" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AO" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="KZ" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="ES" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="MD" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MG" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MA" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="UZ" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MM" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="ML" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MN" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MK" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MW" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MR" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="UG" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MY" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MX" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path d="M839.04,322.8l0.22,1.14l-0.44,0.03l-0.2,-1.45l0.42,0.27Z"
                                                    data-code="VU" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="FJ" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="FK" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NI" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NL" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NO" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NA" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M838.78,341.24l-0.33,0.22l-2.9,-1.75l-3.26,-3.37l1.65,0.83l4.85,4.07Z"
                                                    data-code="NC" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NE" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NG" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NZ" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NP" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CI" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CH" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CO" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CN" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CM" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CL" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CA" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CG" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CF" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CD" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CZ" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M504.36,193.47l0.43,0.28l-1.28,0.57l-0.92,-0.28l-0.24,-0.46l2.01,-0.13Z"
                                                    data-code="CY" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CR" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="SY" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="SS" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SR" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="SK" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="KR" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="SO" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SN" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SL" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SB" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SA" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SE" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SD" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="DO" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="DJ" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="DK" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="DE" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="YE" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AT" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="DZ" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="US" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="LV" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="TM" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="TH" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M596.68,420.38l-3.2,0.18l-0.05,-1.26l0.39,-1.41l1.3,0.78l2.08,0.35l-0.52,1.36Z"
                                                    data-code="TF" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="TG" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="TD" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="LY" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AE" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="VE" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AF" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="IQ" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="IS" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="IR" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AM" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="IT" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="VN" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AR" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AU" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="IL" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="IN" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="TZ" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AZ" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="IE" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="ID" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="MZ" fill="#dee2e8" fill-opacity="1"
                                                    stroke="none" stroke-width="0" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                            </g>
                                            ...
                                            <g id="jvm-markers-group">
                                                <circle data-index="0" cx="491.4747329053632"
                                                    cy="163.97582106611338" r="9" fill="#3B7DDD" fill-opacity="1"
                                                    stroke="#FFF" stroke-width="7" stroke-opacity="0.5"
                                                    stoke-opacity="0.4" class="jvm-marker jvm-element"></circle>
                                                <circle data-index="1" cx="416.16909467685576"
                                                    cy="168.66859163966018" r="9" fill="#3B7DDD" fill-opacity="1"
                                                    stroke="#FFF" stroke-width="7" stroke-opacity="0.5"
                                                    stoke-opacity="0.4" class="jvm-marker jvm-element"></circle>
                                                <circle data-index="2" cx="291.047885900245"
                                                    cy="207.65514424498488" r="9" fill="#3B7DDD" fill-opacity="1"
                                                    stroke="#FFF" stroke-width="7" stroke-opacity="0.5"
                                                    stoke-opacity="0.4" class="jvm-marker jvm-element"></circle>
                                                <circle data-index="3" cx="522.3938566376568"
                                                    cy="155.4975688344802" r="9" fill="#3B7DDD" fill-opacity="1"
                                                    stroke="#FFF" stroke-width="7" stroke-opacity="0.5"
                                                    stoke-opacity="0.4" class="jvm-marker jvm-element"></circle>
                                                <circle data-index="4" cx="477.54209257648034"
                                                    cy="178.78871722935696" r="9" fill="#3B7DDD" fill-opacity="1"
                                                    stroke="#FFF" stroke-width="7" stroke-opacity="0.5"
                                                    stoke-opacity="0.4" class="jvm-marker jvm-element"></circle>
                                                <circle data-index="5" cx="159.71186487432297"
                                                    cy="145.5933978801038" r="9" fill="#3B7DDD" fill-opacity="1"
                                                    stroke="#FFF" stroke-width="7" stroke-opacity="0.5"
                                                    stoke-opacity="0.4" class="jvm-marker jvm-element"></circle>
                                                <circle data-index="6" cx="84.6327421128611"
                                                    cy="158.6417396560298" r="9" fill="#3B7DDD" fill-opacity="1"
                                                    stroke="#FFF" stroke-width="7" stroke-opacity="0.5"
                                                    stoke-opacity="0.4" class="jvm-marker jvm-element"></circle>
                                                <circle data-index="7" cx="136.58981466480722"
                                                    cy="143.23416156155682" r="9" fill="#3B7DDD" fill-opacity="1"
                                                    stroke="#FFF" stroke-width="7" stroke-opacity="0.5"
                                                    stoke-opacity="0.4" class="jvm-marker jvm-element"></circle>
                                                <circle data-index="8" cx="285.0959595460109"
                                                    cy="122.64135607851978" r="9" fill="#3B7DDD" fill-opacity="1"
                                                    stroke="#FFF" stroke-width="7" stroke-opacity="0.5"
                                                    stoke-opacity="0.4" class="jvm-marker jvm-element"></circle>
                                                <circle data-index="9" cx="279.02681281271566"
                                                    cy="146.18874418125023" r="9" fill="#3B7DDD" fill-opacity="1"
                                                    stroke="#FFF" stroke-width="7" stroke-opacity="0.5"
                                                    stoke-opacity="0.4" class="jvm-marker jvm-element"></circle>
                                            </g>
                                                ...
                                                <div class="flatpickr-months"><span
                                                    ...
                                                    <div class="flatpickr-month">
                                                        <div class="flatpickr-current-month"><select
                                                                ...
                                                                <option class="flatpickr-monthDropdown-month"
                                                                    value="0" tabindex="-1">January</option>
                                                                <option class="flatpickr-monthDropdown-month"
                                                                    value="1" tabindex="-1">February</option>
                                                                <option class="flatpickr-monthDropdown-month"
                                                                    value="2" tabindex="-1">March</option>
                                                                <option class="flatpickr-monthDropdown-month"
                                                                    value="3" tabindex="-1">April</option>
                                                                <option class="flatpickr-monthDropdown-month"
                                                                    value="4" tabindex="-1">May</option>
                                                                <option class="flatpickr-monthDropdown-month"
                                                                    value="5" tabindex="-1">June</option>
                                                                <option class="flatpickr-monthDropdown-month"
                                                                    value="6" tabindex="-1">July</option>
                                                                <option class="flatpickr-monthDropdown-month"
                                                                    value="7" tabindex="-1">August</option>
                                                                <option class="flatpickr-monthDropdown-month"
                                                                    value="8" tabindex="-1">September</option>
                                                                <option class="flatpickr-monthDropdown-month"
                                                                    value="9" tabindex="-1">October</option>
                                                                <option class="flatpickr-monthDropdown-month"
                                                                    value="10" tabindex="-1">November</option>
                                                                <option class="flatpickr-monthDropdown-month"
                                                                    value="11" tabindex="-1">December</option>
                                                            </select>
                                                            <div class="numInputWrapper"><input
                                                                    class="numInput cur-year" type="number"
                                                                    tabindex="-1" aria-label="Year"
                                                                    data-cip-id="cIPJQ342845639"><span
                                                                    class="arrowUp"></span><span
                                                                    class="arrowDown"></span></div>
                                                        </div>
                                                    </div><span class="flatpickr-next-month"><span
                                                    ...
                                                    <div class="flatpickr-rContainer">
                                                        ...
                                                        <div class="flatpickr-days" tabindex="-1">
                                                            <div class="dayContainer"><span
                                                                    ...
                                                                    aria-current="date" tabindex="-1">8</span><span
                                                                    class="flatpickr-day"
                                ...
                                <div class="card-body d-flex w-100">
                                    <div class="align-self-center chart chart-lg">
                                        ...
                                        <canvas id="chartjs-dashboard-bar"
                                            style="display: block; height: 350px; width: 277px;" width="554"
