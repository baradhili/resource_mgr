...
use App\Http\Controllers\ForecastDemandController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('demand-requests', DemandRequestController::class);
    Route::resource('demands', DemandController::class);
    Route::resource('forecast-demands', ForecastDemandController::class);
