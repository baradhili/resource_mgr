...
This tool is initially to help manage demand and resource levelling across many projects in an enterprise. Now being extended to manage a practice/s.
It thinks from a point of view of resource management rather than project tasks - unlike most resource management tools. 
...
## Features
    ...
    - Receive Demands  - estimate work required and allocate resources
